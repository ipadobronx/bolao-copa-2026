...
export default function HomePage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 p-8">
      <h1 className="font-display text-7xl tracking-wide text-accent">
        Bolão Copa 2026
      </h1>
      <p className="font-body text-lg text-text-secondary">
        Setup OK — landing page real entra na Feature 3.
      </p>
      <code className="font-mono text-sm text-text-muted">app/(public)/page.tsx</code>
    </main>
  );
}
```
...
export default function PublicLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <footer className="border-t border-border px-6 py-4 text-center font-mono text-xs text-text-muted">
...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen">
      <aside className="hidden w-64 border-r border-border p-6 md:block">
        <span className="font-display text-xl tracking-wide">DASHBOARD</span>
        <p className="mt-2 font-mono text-xs text-text-muted">
          sidebar real na Feature 4
        </p>
      </aside>
...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-4 p-8 text-center">
      <span className="font-display text-8xl tracking-wide text-accent">404</span>
      <p className="font-body text-lg text-text-secondary">
...
export default function GlobalError({
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-4 p-8 text-center">
      <span className="font-display text-7xl tracking-wide text-danger">erro</span>
      ...
      <button
        type="button"
        onClick={() => reset()}
        className="rounded-md border border-border-strong px-4 py-2 font-body text-sm text-text-primary hover:border-accent hover:text-accent"
      >
        Tentar novamente
      </button>
    </main>
